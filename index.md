...
address: "UBVE, Laboratorium (former E -1.01), University Library, Vendelstraat 2, Amsterdam"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "52.368624"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "4.894915"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "March 3-31, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00-15:00"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-03-03      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-03-31        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Anouk Vlug", "Charlie Green", "Pieter Bons", "Bauke van der Velde"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Daan van Versendaal", "Sreenithya Avadakkam", "Ferdinand van den Toorn", "Max Paulus"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
